...
char maptmp[18][32]; //òèì÷àñîâà ìàïà
...
char map[18][32] = {             //Ñëîæíûé óðîâåíü
	"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
	"@ ............................@",
	"@....@..@..@@@@..@@@@..@@@@...@",
	"@....@..@..@  @..@  @..@  @...@",
...
char karta[18][32] = {           //Íîðìàëüíûé óðîâåíü 
	"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
	"@ ............................@",
	"@.@...@..@@@@..@@@@@..@.....@.@",
	"@.@@..@..@  @..@   @..@@...@@.@",
...
char level3[18][32] = {          //Ëåãêèé óðîâåíü
    "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
	"@ ............................@",
	"@....@@@@..@@@@..@@@@..@...@..@",
	"@....@.....@  @..@......@.@...@",
...
int main()
{
	...
	int x = 15;             //ïî÷àòêîâà êîîðäèíàòà x äëÿ ãåðîÿ
	int y = 16;             //ïî÷àòêîâà êîîðäèíàòà y äëÿ ãåðîÿ
	...
	while( running ){		//ïîêè ìè ðóõàºìîñÿ
		...
		if(pts == 300) break; //ÿùêî ê³ëüê³ñòü ç³áðàíî¿ "¿æ¿" 300, òî âèõîäèìî ç öèêëó running

		gotoxy( 32, 1 ); cout << "Your score: " << pts; //ó çàäàíèõ êîîðäèíàòàõ âèâîäèìî íàïèñ "Âàø ðàõóíîê"
		gotoxy( 15, 18 ); cout << "^ ";          //ó çàäàíèõ êîîðäèíàòàõ
		gotoxy( 15, 19 ); cout << "| ";			 // âèâîäèìî ³íôîðìàö³þ	
		gotoxy( 11, 20 ); cout << "You here ";   //ïðî ïîëîæåííÿ ãîëîâíîãî ãåðîÿ                 	
		Sleep( 80 );
		frame++;
	}
	...
	if(pts == 300) //ÿêùî íàáðàíî 300 î÷îê
	{
