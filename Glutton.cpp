...
char maptmp[20][35]; //тимчасова мапа
...
char map[20][35] = {             //Сложный уровень
	"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
	"@ ...............................@",
	"@................................@",
	"@................................@",
...
char karta[20][35] = {           //Нормальный уровень 
	"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
	"@ ...............................@",
	"@................................@",
	"@................................@",
...
char level3[20][35] = {          //Легкий уровень
    "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
	"@ ...............................@",
	"@................................@",
	"@................................@",
...
int main()
{
	...
	int x = 32;             //початкова координата x для героя
	int y = 18;             //початкова координата y для героя
	...
	while( running ){		//поки ми рухаємося
		...
		if(pts == 350) break; //ящко кількість зібраної "їжї" 300, то виходимо з циклу running

		gotoxy( 36, 1 ); cout << "Your score: " << pts; //у заданих координатах виводимо напис "Ваш рахунок"
		gotoxy( 36, 18 ); cout << "<--- You here ";     //у заданих координатах
				                                        // виводимо інформацію	
		                                                //про положення головного героя                 	
		Sleep( 80 );
		frame++;
	}
	...
	if(pts == 350) //якщо набрано 350 очок
	{
